 ...
 * @author Belinha
 */
public class frmPesquisarAlunoExame extends javax.swing.JFrame {
    private CadastrarExame fCadExame;
    /**
     * Creates new form frmPesquisarAlunoExame
     */
    public frmPesquisarAlunoExame() {
        initComponents();
        preencherTela();
    }
    
    public frmPesquisarAlunoExame(javax.swing.JFrame frm) {
        this();
        fCadExame = (CadastrarExame) frm;  
    }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        ArrayList<Aluno> alunos = dao.buscarAlunoTexto(Pesquisa.getText());
    ...
    private void jtAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtAlunosMouseClicked
        if(evt.getClickCount() == 2){
            ...
            fCadExame.setarAluno(nome , Codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPesquisarAlunoExame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPesquisarAlunoExame().setVisible(true);
            }
        });
    }
