 ...
 * @author Belinha
 */
public class PesquisarInstrutor extends javax.swing.JFrame {
    private CadastroDeInstrutor fCadInst;
    /**
     * Creates new form PesquisarInstrutor
     */
    public PesquisarInstrutor() {
        initComponents();
    }
    
    public PesquisarInstrutor(javax.swing.JFrame frm) {
        this();        
        fCadInst = (CadastroDeInstrutor) frm;  
    }
    ...
    private void jtInstrutorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtInstrutorMouseClicked
        if(evt.getClickCount() == 2){
            ...
            String cpf = i.getCPF();
            Date data = i.getDataNascimento();
            String rua = i.getRua();
            String bairro = i.getBairro();
            int numero = i.getNumero();
            int residencial = i.getTelResidencial();
            int celular1 = i.getCelular1();
            int celular2 = i.getCelular2();
            fCadInst.setarCampos(codigo, nome, cpf, data, rua, bairro, numero, residencial, celular1, celular2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarInstrutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarInstrutor().setVisible(true);
            }
        });
    }
