 ...
 * @author Belinha
 */
public class PesquisarAuno extends javax.swing.JFrame {
    private CadastroDeAlunos fCadAuno;
    /**
     * Creates new form PesquisarAuno
     */
    public PesquisarAuno() {
        initComponents();
    }
    
    public PesquisarAuno(javax.swing.JFrame frm) {
        this();        
        fCadAuno = (CadastroDeAlunos) frm;  
    }
    ...
    private void jtAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtAlunosMouseClicked
        if(evt.getClickCount() == 2){
            ...
            int cpf = a.getCPF();
            Date data = a.getDataNascimento();
            String rua = a.getRua();
            String bairro = a.getBairro();
            int numero = a.getNumero();
            String cat = a.getCategoria();
            int residencial = a.getTelResidencial();
            int celular1 = a.getCelular1();
            int celular2 = a.getCelular2();
            fCadAuno.setarCampos(codigo, nome, cpf, data, rua, bairro, numero, cat, residencial, celular1, celular2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarAuno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarAuno().setVisible(true);
            }
        });
    }
