...
public class PesquisarVeiculo extends javax.swing.JFrame {
    private CadastroDeVeiculo fCadVeic;
    /**
    ...
    public PesquisarVeiculo(javax.swing.JFrame frm) {
        this();        
        fCadVeic = (CadastroDeVeiculo) frm;  
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisar Veiculos"));
    ...
    private void jtVeiculoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtVeiculoMouseClicked
        if(evt.getClickCount() == 2){
            ...
            String cor = v.getCor();
            String combustivel = v.getTipoCombustivel();
            String modelo = v.getModelo();
            int ano = v.getAno();
            fCadVeic.setarCampos(placa, cor, combustivel, modelo, ano);
